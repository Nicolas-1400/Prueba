...
package net.mcreator.eee.block;
...
public class BlockRojoSlab extends ElementsEeeMod.ModElement {
	@GameRegistry.ObjectHolder("eee:rojo_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("eee:rojo_slab_double")
	public static final Block block_slab_double = null;
	public BlockRojoSlab(ElementsEeeMod instance) {
		super(instance, 9);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("rojo_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("rojo_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("eee:rojo_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setUnlocalizedName("rojo_slab");
